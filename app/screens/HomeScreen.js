...
import { Text, View, StyleSheet, Button, Modal, TouchableOpacity, Image, ImageBackground } from "react-native";
...
function HomeScreen({ navigation }) {
	...
	return (
		...
		<ImageBackground source = {bg} style={{borderTopRightRadius: 60, borderTopLeftRadius: 60, overflow: 'hidden', resizeMode: "stretch", height: "100%"}}>
			 <View style={{height: "70%", padding:20, alignItems: "center"}}>
				<TouchableOpacity onPress={() => navigation.navigate("Survey Categories")} style={styles.card}>
					<Text style={styles.buttonText}>Take Resource Survey</Text>
					<Image source={callCenter} style={styles.icon}/>
				</TouchableOpacity>

				<TouchableOpacity onPress={() => navigation.navigate("Resource List")} style={styles.card}>
			...
			<View style={styles.emergency}>
				<Text style={{color: '#F1F2F2', textAlign: "center", marginBottom: 10}}>This button is intended for use ONLY in case of an emergency.</Text>
				<TouchableOpacity onPress={() => setModalVisible(true)} style={{alignSelf: "center", alignItems: "center", backgroundColor: "#A32E2E", width: "80%", padding: 10, borderTopRightRadius: 20,borderTopLeftRadius: 20, borderBottomRightRadius: 20, borderBottomLeftRadius: 20,}}>
