...
import { Text, SafeAreaView, StyleSheet, SectionList, FlatList, TouchableOpacity, View } from "react-native";
...
const App = () => {
	...
	return (
		<View>
			...
			<Text style={styles.subtext}>Based on your survey results, here are some resources that might be helpful to you.</Text>
